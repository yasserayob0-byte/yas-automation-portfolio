        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          >
            <div className="flex items-center gap-2">
              <span className="text-xl sm:text-2xl font-black tracking-tighter text-white font-heading">
                YAS
              </span>
              <span className="text-xl sm:text-2xl font-extrabold tracking-tight bg-gradient-to-r from-cyan-400 via-sky-300 to-indigo-400 bg-clip-text text-transparent font-heading">
                AUTOMATION
              </span>
              <span className="hidden sm:inline-block w-2 h-2 rounded-full bg-cyan-400 animate-pulse" />
            </div>
            <span className="text-[9px] sm:text-[10px] uppercase tracking-[0.22em] text-slate-400 font-medium group-hover:text-cyan-400 transition-colors">
          ...
          <div className="hidden sm:flex items-center gap-3">
            <div className="hidden xl:flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-[11px] text-emerald-400 font-mono">
          ...
          <div className="flex lg:hidden items-center gap-2">
            <button
              onClick={() => onOpenContact()}
              className="px-3.5 py-1.5 rounded-full bg-cyan-500/20 border border-cyan-500/40 text-xs font-semibold text-cyan-300 sm:hidden"
            >
              Talk
            </button>
            <button
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="fixed inset-x-0 top-[65px] z-40 bg-[#090d16]/95 backdrop-blur-2xl border-b border-slate-800 p-6 lg:hidden shadow-2xl"
          >
