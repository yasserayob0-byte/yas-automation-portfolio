  ...
  const services = [
    {
      ...
      description: 'Design intelligent automation workflows that eliminate repetitive tasks and improve operational efficiency.',
      icon: Sparkles,
      tag: 'Autonomous AI',
    ...
    },
    {
      ...
      description: 'Build scalable, event-driven workflows integrating multiple platforms and APIs.',
      icon: Workflow,
      tag: 'Orchestration',
    ...
    },
    {
      ...
      description: 'Automate lead nurturing, appointment booking, reminders, pipelines, and customer communication.',
      icon: Layers,
      tag: 'Full-Funnel CRM',
    ...
    },
    {
      ...
      description: 'Connect business applications through APIs, webhooks, and custom automation logic.',
      icon: Code2,
      tag: 'Custom Bridges',
    ...
    },
    {
      ...
      description: 'Develop AI-powered assistants capable of handling customer inquiries using modern language models.',
      icon: Bot,
    ...
    },
    {
      ...
      description: 'Transform manual business operations into efficient, scalable automation systems.',
      icon: Zap,
              ...
              >
                ...
                <div className="space-y-5 relative z-10">
                  ...
                  <div className="flex items-center justify-between">
                    <div className={`w-13 h-13 rounded-2xl ${service.iconBg} border flex items-center justify-center group-hover:scale-110 transition-transform shadow-lg`}>
